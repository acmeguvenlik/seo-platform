...
export default function CompetitorAnalysisPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch("/api/tools/competitor-analysis", {
        method: "POST",
  ...
  return (
    <ToolPageTemplate
      ...
      description="Rakiplerinizi analiz edin ve stratejinizi geliştirin."
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className={cn(theme.text.small, theme.text.muted, "mt-1")}>
            Rakip analizi yapmak istediğiniz web sitesinin URL'sini girin
          </p>
        </div>
      </div>
    </ToolPageTemplate>

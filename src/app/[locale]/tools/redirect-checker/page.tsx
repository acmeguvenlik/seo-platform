...
export default function RedirectCheckerPage() {
  ...
  return (
    <ToolPageTemplate
      ...
      description="URL yönlendirme zincirlerini kontrol edin. 301, 302 redirect'leri tespit edin ve SEO sorunlarını önleyin."
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className={cn(theme.text.small, theme.text.muted, "mt-1")}>
            Redirect zincirini kontrol etmek istediğiniz URL
          </p>
        </div>
      </div>
    </ToolPageTemplate>

...
export default function DomainAuthorityCheckerPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch("/api/tools/domain-authority-checker", {
        method: "POST",
  ...
  return (
    <ToolPageTemplate
      ...
      description="Domain authority skorunuzu kontrol edin ve SEO gücünüzü ölçün."
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className={cn(theme.text.small, theme.text.muted, "mt-1")}>
            Domain authority kontrol etmek istediğiniz web sitesinin URL'sini girin
          </p>
        </div>
      </div>
    </ToolPageTemplate>

...
export default function SslCheckerPage() {
  ...
  return (
    <ToolPageTemplate
      ...
      description="Web sitenizin SSL sertifikasını kontrol edin. HTTPS güvenliği ve HSTS ayarlarını doğrulayın."
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className={cn(theme.text.small, theme.text.muted, "mt-1")}>
            Kontrol etmek istediğiniz web sitesinin URL'sini girin
          </p>
        </div>
      </div>
    </ToolPageTemplate>

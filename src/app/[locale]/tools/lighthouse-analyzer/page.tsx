...
export default function LighthouseAnalyzerPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch("/api/tools/lighthouse-analyzer", {
        method: "POST",
  ...
  return (
    <ToolPageTemplate
      ...
      description="Google Lighthouse skorlarını analiz edin ve performansı optimize edin."
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className={cn(theme.text.small, theme.text.muted, "mt-1")}>
            Lighthouse analizi yapmak istediğiniz web sitesinin URL'sini girin
          </p>
        </div>
      </div>
    </ToolPageTemplate>
